...
<head>
  ...
  <title>Cable Vd - <?php include('../includes/title.php');?></title>
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Cable Vd</a>
        </div>
            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"> Cable Vd  &nbsp
...
include('../includes/dbcon.php');
    ...
    $query=mysqli_query($con,"SELECT * FROM cable_vd 
    INNER JOIN cable_type ON cable_vd.type_id = cable_type.type_id
    INNER JOIN cable_size ON cable_vd.size_id = cable_size.size_id")or die(mysqli_error($con));
...
<div id="update<?php echo $id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!--start form-->
              <form class="form-horizontal" method="post" action="cable_vd_update.php" enctype='multipart/form-data'>
...
<div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!--start form-->
            <form class="form-horizontal" method="post" action="cable_vd_save.php" enctype='multipart/form-data'>
            ...
            <div class="modal-body" style="height:120px">
              ...
              <form class="form-horizontal" method="post">
                  ...
                  <div class="alert alert-danger">
                      Are you sure you want to delete this item <?php echo $cname,", Size=",$csize,", Vd=",$cvd;?>?
                    </div>                     
                  <!-- Buttons -->
                  <div class="form-group">
                      <!-- Buttons -->
...
<?php
  ...
  // sending query
  mysqli_query($con,"DELETE FROM cable_vd WHERE vd_id='$id'")
