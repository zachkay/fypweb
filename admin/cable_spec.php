...
<head>
  ...
  <title>Cable Spec - <?php include('../includes/title.php'); ?></title>
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <span class="divider">/</span>
          <a href="#" class="bread-current">Cable Specifications</a>
        </div>
            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"> Cable Specifications &nbsp
                      ...
                      <div class="table-responsive">
                        <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%">
                          ...
                          <tbody>
                            ...
                            $query = mysqli_query($con, "SELECT * FROM cable_spec 
                            INNER JOIN cable_type ON cable_spec.type_id = cable_type.type_id
                            INNER JOIN cable_size ON cable_spec.size_id = cable_size.size_id") or die(mysqli_error($con));
                            ...
                            ?>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="height:460px">
                                      ...
                                      <!--start form-->
                                      <form class="form-horizontal" method="post" action="cable_spec_update.php" enctype='multipart/form-data'>
                                        ...
                                        <!-- Title -->
                                        <div class="form-group">
                                          <label class="control-label col-lg-4" for="title">Cable Vd</label>
                                          <div class="col-lg-12">
                                            <input type="number" step="0.1" class="form-control form-control-sm" name="txt_vd" id="title" value="<?php echo $cvd; ?>" placeholder="Enter Cable Vd" required>
                                          </div>
                                        </div>
                                        <!-- Title -->
                                        <div class="form-group">
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="height:460px">
                                      ...
                                      <!--start form-->
                                      <form class="form-horizontal" method="post" action="cable_spec_save.php" enctype='multipart/form-data'>
                                        ...
                                        <div class="form-group">
                                          <label class="control-label col-lg-4" for="title">Cable Vd</label>
                                          <div class="col-lg-12">
                                            <input type="number" step="0.1" class="form-control form-control-sm" name="txt_vd" id="title" placeholder="Enter Cable Vd" required>
                                          </div>
                                        </div>
                                        <!-- Title -->
                                        <div class="form-group">
                                    ...
                                    <div class="modal-body" style="height:140px">
                                      ...
                                      <form class="form-horizontal" method="post">
                                        ...
                                        <div class="alert alert-danger">
                                          Are you sure you want to delete this item <?php echo $cname, ", Size=", $csize, ", Iz=", $ciz, " Vd=", $cvd, " Price=", $cprice; ?> ?
                                        </div>
                                        <!-- Buttons -->
                                        <div class="form-group">
                                          <!-- Buttons -->
                              ...
                              if (isset($_POST['del'])) {
                                ...
                                // sending query
                                mysqli_query($con, "DELETE FROM cable_spec WHERE spec_id='$id'")
